...
public class Finder {
    ...
    public Finder(String urlCatalog, String[] keywords) {
        ...
        if (currentOs.startsWith("Windows")){
            ...
            //System.setProperty("webdriver.chrome.driver", "C:\\Users\\soimaka.EXPERTIZA\\source\\repos\\diplom-ifmo\\sources\\chromedriver.exe");//Драйвермендежер не работает корректно
